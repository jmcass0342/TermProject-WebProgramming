        ...
        <!-- /.row -->
		  ...
		  <#list program1 as day1>
		  	<tr>
				...
				<td><iframe width="200" height="200" src="https://www.youtube.com/embed/${day1.video}"></iframe></td>
		  ...
		  <#list program2 as day2>
		  	<tr>
				...
				<td><iframe width="200" height="200" src="https://www.youtube.com/embed/${day2.video}"></iframe></td>
		  ...
		  <#list program3 as day3>
		  	...
		  	<tr>
				...
				<td><iframe width="200" height="200" src="https://www.youtube.com/embed/${day3.video}"></iframe></td>
