...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Build Workout
                    <small></small><!--Subheading can go here -->
                </h1>
                <ol class="breadcrumb">
                    <li><a href="Home">Home</a>
                    </li>
                    <li class="active">Build Workout</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
...
<div>
<h3>Choose one Tier1:</h3><br>
<table>
<#list tier1 as tierone>
<tr>
	<td><input type="radio" name="getId1" value="${tierone.id}"></td> <td style="margin-top:5px"><label>${string1[tierone_index]}</label></td>
</tr>
</#list>
</table>
</div>
...
<div>
<h3>Choose one Tier2:</h3><br>
<table>
<#list tier2 as tiertwo>
<tr>
	<td><input type="radio" name="getId2" value="${tiertwo.id}"></td> <td><label>${string2[tiertwo_index]}</label></td>
</tr>
</#list>
...
<div>
<h3>Choose one Tier3:</h3><br>
<table>
<#list tier3 as tierthree>
<tr>
	<td><input type="radio" name="getId3" value="${tierthree.id}"></td> <td><label>${string3[tierthree_index]}</label></td>
</tr>
</#list>
