...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Ask An Expert
        ...
        <div class="row">
            <div class="col-md-8">
                <h3>Send An Expert A Message</h3>
                <#list users as user>
                <form action="mailto:jdeweever1996@gmail.com" method="POST" enctype="text/plain">
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Full Name:</label>
                            <input type="text" class="form-control" id="name" value="${user.firstName} ${user.lastName}" required data-validation-required-message="Please enter your name.">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="email" class="form-control" id="email" value="${user.email}" required data-validation-required-message="Please enter your email address.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                ...
                <a href="Home" class="btn btn-primary">Return Home</button></a>
                </#list>
            </div>
