...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="AddTiers" method="POST">
<h3> Select the type of tier you are going to add</h3>
			<input type ="radio" name="tier" value="1" required><label>1</label>
			<input type ="radio" name="tier" value= "2" required><label>2</label>
			<input type ="radio" name="tier" value= "3" required><label>3</label>
