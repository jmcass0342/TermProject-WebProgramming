...
public class Demonstration extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			root.put("users", show.getUsers());
			root.put("exercises", show.getExercises());
			root.put("tier1", show.getTier1());
			root.put("tier2", show.getTier2());
			root.put("tier3", show.getTier3());
			root.put("workouts", show.getWorkout());
			root.put("programs", show.getPrograms());
			root.put("hasPrograms", show.getHasPrograms());
			show.disconnect();
