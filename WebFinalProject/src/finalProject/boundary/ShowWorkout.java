...
/**
 * Servlet implementation class ShowWorkout
 */
@WebServlet("/ShowWorkout")
public class ShowWorkout extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static  String         templateDir = "WEB-INF/templates";
	static  String         scheduleTemplateName = "Schedule.ftl";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			if(!programForWeek.isEmpty()){ // check there is a program for the week
				...
				root.put("reason", "No Workout for this week");
				setUpTemplate(request,response,failureTemplateName);
			}
