 ...
 */
@WebServlet("/CreateExerciseList")
public class CreateExerciseList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String exerciseTier = request.getParameter("tier");
		try {
			ShowDemo show = new ShowDemo();
			root.put("exercises", show.getExerciseByTier(Integer.parseInt(exerciseTier)));
			root.put("tier", exerciseTier);
			show.disconnect();
